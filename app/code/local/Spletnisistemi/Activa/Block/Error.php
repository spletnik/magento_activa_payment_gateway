 ...
 */
class Spletnisistemi_Activa_Block_Error extends Mage_Core_Block_Abstract {
    protected function _construct() {
        parent::_construct();
        $this->setTemplate('activa/error.phtml');
    }

    protected function _toHtml() {
        $html = "
        <div class='page-head'>
            <h3>{$this->__('SPLETNISISTEMI_ACTIVA_PAYMENT_ERROR')}</h3
        </div>
        ...
        <p>{$this->__('SPLETNISISTEMI_ACTIVA_FAILURE_CONTINUE_SHOPPING', $this->getContinueShoppingUrl())}</p>";
