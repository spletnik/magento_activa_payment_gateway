...
class Spletnisistemi_Activa_Model_Activa_Order {
    ...
    function commit() {
        ...
        $sql = 'INSERT INTO ' . Mage::getSingleton('core/resource')->getTableName('activa_api_debug') . '
    ...
    function fetch($val) {
        $write = Mage::getSingleton('core/resource')->getConnection('core_write');
        $result = $write->query("SELECT * FROM ".Mage::getSingleton('core/resource')->getTableName('activa_api_debug')." WHERE paymentID=?", array($val))->fetch();
    ...
    function update() {
        $write = Mage::getSingleton('core/resource')->getConnection('core_write');
        $sql = "UPDATE ".Mage::getSingleton('core/resource')->getTableName('activa_api_debug')." SET result=?, auth=?, ref=?, tranID=?, postDate=?, udf1=?, udf2=?, udf3=?, udf4=?, udf5=?, responseCode=? WHERE paymentID = ?";
    ...
    function updateErr() {
        $write = Mage::getSingleton('core/resource')->getConnection('core_write');
        $sql = "UPDATE ".Mage::getSingleton('core/resource')->getTableName('activa_api_debug')." SET errMsg=?, errText=? WHERE paymentID = ?";
